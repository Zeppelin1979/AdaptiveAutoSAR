#ifndef ARA_CRYPTO_CRYP_ENCRIPTOR_PUBLIC_CTX_H
#define ARA_CRYPTO_CRYP_ENCRIPTOR_PUBLIC_CTX_H
...
namespace ara
{
    namespace crypto
    {
        ...
        {
            /**
             * @brief [SWS_CRYPT_21000]
             * Asymmetric Encryption Public key Context interface.
             */
            ...
            public:
                ...
                /**
                 * @brief [SWS_CRYPT_21010]
                 * Set (deploy) a key to the encryptor public algorithm context.
...
#endif // ARA_CRYPTO_CRYP_ENCRIPTOR_PUBLIC_CTX_H