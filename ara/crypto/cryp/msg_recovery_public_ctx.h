    ...
    namespace crypto
    {
        namespace cryp
        {
            ...
            public:
                 ...
                 * @return ara::core::Result<ara::core::Vector<ara::core::Byte> > the output buffer actual size of output data (it always <= out.size()) or 0 if the input data block has incorrect content
...
//                ara::core::Result<ByteVector<Alloc> > DecodeAndVerify (ReadOnlyMemRegion in) const noexcept;
                ...
                /**
                 * @brief [SWS_CRYPT_22211]
                 * Set (deploy) a key to the msg recovery public algorithm context.
